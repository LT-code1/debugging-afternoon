...
class App extends Component {
  ...
  componentDidMount() {
    axios
      ...
      .then(response => {
        this.setState({
          products: response.data        ///when getting data with an axios call the obj.data property has to be pushed to get data array
        });
      });
  }
  addToCart(item) {
      this.setState({cart: [...this.state.cart,item]})           ///have to additem to cart here
  }
